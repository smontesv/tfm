...
def CreaRegistrosIniciles(pHost, pUser, pPassword, pDB):
    ...
    try:
        with Conexion.cursor() as Cursor:
            ...
            Cursor.execute(stSQL)
            print ('-> Paso 1.1 Limpia las tablas')
            ...
            print ('-> Paso 1.5 HIST_PRINCIPAL_A')
            ...
            print ('-> Paso 1.6 HIST_PRINCIPAL_B')
            ...
            print ('-> Paso 1.7. Creación de los Históricos Secundarios o Dependientes')
...
def CreaRegistrosErrorTipoI(pHost, pUser, pPassword, pDB, pNumEjemplos):
    ...
    try:
        with Conexion.cursor() as Cursor:
            ...
            print("Paso 2.- Se han generado los errores tipo I")
    ...
    try:
        with Conexion.cursor() as Cursor:
            ...
            for i in range(0,pNumEjemplos):
                ...
                stSQL = stSQL + stWhere
                Cursor.execute(stSQL,vecWhere)
        print("Paso 3.- Se han generado los errores tipo II")
